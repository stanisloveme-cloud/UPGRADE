...
Это документ с целевыми CJM по ролям. Каждый сценарий покрывает основные рабочие процессы и выявляет потребности и риски для каждого типа пользователя.

Далее я использовал своего агента системного аналитика в Gemini, и он подготовил мне техническое задачание PRD-001.md, PRD-002.md, PRD-003.md, PRD-004.md
